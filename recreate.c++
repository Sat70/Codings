...
class bms{
    ...
    public: // data abstraction
        ...
        void authenticate(){
            ...
            gotoxy(26, 4);
            design(15, 177);
            cout<<" WELCOME TO RK PUBLIC BANK ";
            design(15, 177);
            login();
            if (verify() == 1) {
                if (m == 1)
...
void bms:: view(){
    ...
    //read from the file
    ifstream f;
    f.open("record1.bin", ios::in | ios::binary); //open file for read only
    gotoxy(25, 3);
    design(25, 177);
    cout<<" CUSTOMERS LIST ";
    design(25, 177);
...
void bms:: add(){
    ...
    ofstream f;
    f.open("record1.bin", ios::app | ios::binary); // data will be written at end of the file
    int i = 0, x;
...
int chkacc(int a) {
    ...
    //read binary
    ifstream f;
    f.open("record1.bin", ios::in | ios::binary);
    while (!f.eof(  )) {
...
re: //label for goto
    ...
    scanf("%d", &a);
    if (chkacc(a) == 1) {
        f1.open("record1.bin", ios::in | ios::binary); //read
...
re:
    ...
    scanf("%d", &a);
    if (chkacc(a) == 1) {
        f1.open("record1.bin", ios::in | ios::binary);
        ...
        ifstream f2;
        ofstream f1;
        f1.open("record1.bin", ios::out | ios::binary); // write only
